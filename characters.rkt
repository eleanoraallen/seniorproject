...
(define SPELLSWORD
  (new player%
       ...
       [character-inventory (make-inventory STAFF (list HAT COAT BOOTS MITTENS) (list empty empty empty empty empty) (list HEALING-POTION MAGIC-POTION) (list (add-gold 5)))]
